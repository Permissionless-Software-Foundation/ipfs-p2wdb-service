...
const BCHADDR = 'bitcoincash:qpufm97hppty67chexq4p53vc29mzg437vwp7huaa3'
const MESSAGE = 'test'
const SIGNATURE = 'IF/T3ZjFFjL9FF/STFJNR9h3Y60ME39cSBGe4RfAWwNEER3E9cbyspbGVwpnymlxH/Ix/GIldbguQeDDwD58r3w='
...
const dataObj = {
  ...
  data: {
    entry: {
      entry: 'example.com',
      signature: 'H4hm3GpFAoU7ZtirdF561nHjUJtfuFOPQnMwlsiAUNLjDwP9UG2emjrP303XzB8cH3eg3A1SFNmgQfru1guyiFQ=',
      slpAddress: 'simpleledger:qpufm97hppty67chexq4p53vc29mzg437vz64vfar0',
      description: 'webhook test',
      category: 'Bitcoin Cash'
    }
  }
}
console.log(`Adding this object to the P2WDB: ${JSON.stringify(dataObj, null, 2)}`)
// REST API servers.
