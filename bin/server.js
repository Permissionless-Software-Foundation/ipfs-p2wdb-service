...
class Server {
  ...
  async startServer () {
    try {
      ...
      console.log(`Connecting to MongoDB with this connection string: ${this.config.database}`)
      ...
      console.log('Exiting after 5 seconds. Depending on process manager to restart.')
