...
// Local libraries
import AddEntry from '../../../../src/use-cases/entry/add-entry.js'
...
describe('#AddEntry', () => {
  ...
  beforeEach(() => {
    ...
    rawData = {
      ...
      message: 'test',
      signature: 'IA8LCUnN6TUocSGnCe9nA1T4D+9hurJJ0vi3vBEJvAVwFfGcZ9ZlIWdR1m30wAxO4r0wb3YSzrM3QynpfgKUW/w=',
      data: '{"appId":"test","title":"7170","sourceUrl":"63156","ipfsUrl":"73680","timestamp":"2021-06-23T00:26:51.789Z","localTimestamp":"6/22/2021, 5:26:51 PM"}'
    }
  ...
  describe('#constructor', () => {
    ...
    it('should throw an error if p2wdb instance is not included', () => {
      try {
        ...
        assert.include(err.message, 'p2wdb adapter instance must be included when instantiating AddEntry')
      }
    })
    ...
    it('should throw an error if entry adapter instance is not included', () => {
      try {
        ...
        assert.include(err.message, 'entry adapter instance must be included when instantiating AddEntry use case')
      }
    })
  })
