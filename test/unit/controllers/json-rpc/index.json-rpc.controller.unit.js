  ...
  describe('#constructor', () => {
    it('should throw an error if adapters are not passed in', () => {
      try {
        ...
        assert.include(err.message, 'Instance of Adapters library required when instantiating JSON RPC Controllers.')
      }
    })
    it('should throw an error if useCases are not passed in', () => {
      try {
        ...
        assert.include(err.message, 'Instance of Use Cases library required when instantiating JSON RPC Controllers.')
      }
    })
  })
  describe('#router', () => {
    ...
    it('should return default response if routing is not possible', async () => {
      ...
      assert.equal(jsonObj.payload.result.value.message, 'Input does not match routing rules.')
    })
