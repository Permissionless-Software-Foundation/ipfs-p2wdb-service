...
import EntryRPC from '../../../../src/controllers/json-rpc/entry/index.js'
  ...
  describe('#constructor', () => {
    it('should throw an error if adapters are not passed in', () => {
      try {
        ...
        assert.include(err.message, 'Instance of Adapters library required when instantiating P2WDB JSON RPC Controller.')
      }
    })
    it('should throw an error if useCases are not passed in', () => {
      try {
        ...
        assert.include(err.message, 'Instance of Use Cases library required when instantiating P2WDB JSON RPC Controller.')
      }
    })
  })
  describe('#readAll', () => {
