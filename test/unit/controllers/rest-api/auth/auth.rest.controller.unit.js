  ...
  describe('#constructor', () => {
    it('should throw an error if adapters are not passed in', () => {
      try {
        ...
        assert.include(err.message, 'Instance of Adapters library required when instantiating Auth REST Controller.')
      }
    })
    it('should throw an error if useCases are not passed in', () => {
      try {
        ...
        assert.include(err.message, 'Instance of Use Cases library required when instantiating Auth REST Controller.')
      }
    })
  })
  describe('#authUser', () => {
